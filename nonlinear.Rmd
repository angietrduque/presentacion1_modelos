...
El cual seria un modelo aditivo GAM en el cual calculamos una $f_j$ separada para cada $X_j$ y luego sumamos todas sus contribuciones.

Los GAM también se pueden utilizar en situaciones en las que Y es cualitativo.

##
### **Cualidades del modelo GAM**
